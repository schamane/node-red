...
const api = {
    ...
    listProjects(opts) {
        return runtime.storage.projects
            .listProjects(opts.user)
            .then(function (list) {
            const active = runtime.storage.projects.getActiveProject(opts.user);
            const response = {
                projects: list
            };
            if (active) {
    ...
    setActiveProject(opts) {
        const currentProject = runtime.storage.projects.getActiveProject(opts.user);
